    ...
    <div class="panel-body">
      <form name="falcorClientForm" id="falcorClientForm">
        ...
        <div ng-if="$ctrl.activeTab === 'setValue'">
          ...
          <button
            ng-click="$ctrl.setValue($ctrl.paths[0], $ctrl.args)"
            ng-disabled="falcorClientForm.$invalid"
            type="submit"
        ...
        <div ng-if="$ctrl.activeTab === 'set'">
          ...
          <button
            ng-click="$ctrl.set($ctrl.paths[0])"
            ng-disabled="falcorClientForm.$invalid"
            type="submit"
            class="btn btn-warning">
            Set
        ...
        <div ng-if="$ctrl.activeTab === 'call'">
          ...
          <div class="form-group">
            ...
            <button
              ng-click="$ctrl.call($ctrl.paths[0], $ctrl.args, $ctrl.refPaths, $ctrl.thisPaths)"
              ng-disabled="falcorClientForm.$invalid"
              type="submit"
